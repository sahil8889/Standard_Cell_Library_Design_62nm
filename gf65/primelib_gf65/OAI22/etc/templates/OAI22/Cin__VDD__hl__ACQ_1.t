...
$tempAcq setState "!A&!B&!C&!D&!OUT&!VSS"
$tempAcq setStateCoverage "1"

## 
## Wavetable
set tempWT [ SBWaveTable ]
$tempWT setInterface { A C B D VSS VDD } { initial_delay units ct default_slew pp }

$tempWT setStimulus            {   A    C    B    D    VSS  VDD   } {
                   "0"      {} {   0    0    0    0    0    1     }
       "initial_delay" { in1 } {   -    -    -    -    -    0     }
"(initial_delay)+(pp)"      {} {   -    -    -    -    -    -     }
}
...
$tempWT bindInterface { A C B D VSS VDD } { 10e-12 VDD[cycle_time] VDD[cycle_time] VDD[default_slew] cell_power_period }
