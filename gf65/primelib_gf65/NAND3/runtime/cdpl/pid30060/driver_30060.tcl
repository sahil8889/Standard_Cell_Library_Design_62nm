if { [catch {
set_location /home/eng/s/sxv240035/cad/gf65/primelib_gf65/NAND3
...
set_config_opt -- cdpl_log_subdir pid30060

create_parameter configure_arc_based
set_config_opt -cell NAND3 -- configure_arc_based 0
...
if {[catch {
  ...
  reset_log_file
  if { [log_num_errors] > 0 } {
    if { [catch {exec mv -f $sis_log_file /home/eng/s/sxv240035/cad/gf65/primelib_gf65/NAND3/runtime/cdpl/pid30060} mv_err] } {
      log_warning $mv_err
    }
  } else {
