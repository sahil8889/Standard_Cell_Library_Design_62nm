...
$tempAcq setState "!A&!B&!C&!OUT&!VDD"
$tempAcq setStateCoverage "1"

## 
## Wavetable
set tempWT [ SBWaveTable ]
$tempWT setInterface { A C VSS B VDD } { initial_delay units ct default_slew pp }

$tempWT setStimulus            {   A    C    VSS  B    VDD   } {
                   "0"      {} {   0    0    0    0    0     }
       "initial_delay" { in1 } {   -    -    1    -    -     }
"(initial_delay)+(pp)"      {} {   -    -    -    -    -     }
}
...
$tempWT bindInterface { A C VSS B VDD } { 10e-12 VSS[cycle_time] VSS[cycle_time] VSS[default_slew] cell_power_period }
