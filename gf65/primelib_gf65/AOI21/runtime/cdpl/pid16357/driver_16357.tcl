if { [catch {
set_location /home/eng/s/sxv240035/cad/gf65/primelib_gf65/AOI21
...
set_config_opt -- cdpl_log_subdir pid16357

create_parameter configure_arc_based
set_config_opt -cell AOI21 -- configure_arc_based 0
...
if {[catch {
  ...
  reset_log_file
  if { [log_num_errors] > 0 } {
    if { [catch {exec mv -f $sis_log_file /home/eng/s/sxv240035/cad/gf65/primelib_gf65/AOI21/runtime/cdpl/pid16357} mv_err] } {
      log_warning $mv_err
    }
  } else {
