...
# Date Thu, 05 Dec 2024 22:07:48 CST #
#                                                                            #
...
## 
## Formal Ports
$tempTestColl makeFormalPorts {A B S VSS VDD OUT}
...
## 
## Test delay__S__hl__OUT__hl
set tempTest [ SBTest "delay__S__hl__OUT__hl" ]
$tempTest setTargets { delay__S__hl__OUT__hl Cin__S__hl Tout__OUT__hl cap_energy__OUT__hl energy1__S__hl__OUT__hl__VDD energy__S__hl__OUT__hl leakage_power1__VDD leakage_power2__VDD }
...
$tempAcq setState "B&!A"
$tempAcq setStateCoverage "1"
$tempAcq setAdditionalStateCoverage "1" "leakage_power1__VDD"
$tempAcq setAdditionalStateCoverage "1" "energy__S__hl__OUT__hl"
$tempAcq setAdditionalStateCoverage "1" "energy1__S__hl__OUT__hl__VDD"
...
$tempWT setInterface { A S B OUT:inout } { initial_delay units ct default_slew pp energy_change_threshold energy_change_abs_threshold }

$tempWT setStimulus                  {   A    S    B    OUT   } {
                   "0"            {} {   0    1    1    Z,1   }
...
$tempWT addMeasurements {} {
  ...
  { delay_S_OUT          delay      { S start OUT out } NO_USER SYS }
  { energy__S__hl__OUT__hl energy     { start pp energy_change_threshold energy_change_abs_threshold 0 } NO_USER SYS }
  { cell_power_period    export_expr { pp } }
  { energy1__S__hl__OUT__hl__VDD energy1    { start pp energy_change_threshold energy_change_abs_threshold 0 VDD } }
...
$tempWT bindInterface { A S B OUT } { 10e-12 S[cycle_time] S[cycle_time] S[default_slew] cell_power_period power_stabilization_threshold power_stabilization_threshold_absolute }
