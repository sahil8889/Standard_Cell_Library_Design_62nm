...
$tempAcq setState "!A&!B&!OUT&!S&!VSS"
$tempAcq setStateCoverage "1"

## 
## Wavetable
set tempWT [ SBWaveTable ]
$tempWT setInterface { A S B VDD VSS } { initial_delay units ct default_slew pp }

$tempWT setStimulus            {   A    S    B    VDD  VSS   } {
                   "0"      {} {   0    0    0    0    0     }
       "initial_delay" { in1 } {   -    -    -    1    -     }
"(initial_delay)+(pp)"      {} {   -    -    -    -    -     }
}
...
$tempWT bindInterface { A S B VDD VSS } { 10e-12 VDD[cycle_time] VDD[cycle_time] VDD[default_slew] cell_power_period }
