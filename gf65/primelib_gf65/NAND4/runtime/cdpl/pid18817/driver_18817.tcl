if { [catch {
set_location /home/eng/s/sxv240035/cad/gf65/primelib_gf65/NAND4
...
set_config_opt -cell NAND4 -- configure_arc_based 0
...
if {[catch {
  ...
  reset_log_file
  if { [log_num_errors] > 0 } {
    if { [catch {exec mv -f $sis_log_file /home/eng/s/sxv240035/cad/gf65/primelib_gf65/NAND4/runtime/cdpl/pid18817} mv_err] } {
      log_warning $mv_err
    }
  } else {
