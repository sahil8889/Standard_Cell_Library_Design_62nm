...
$tempAcq setState "!EN&!IN&!OUT&!VSS"
$tempAcq setStateCoverage "1"

## 
## Wavetable
set tempWT [ SBWaveTable ]
$tempWT setInterface { VSS VDD EN IN } { initial_delay units ct default_slew pp }

$tempWT setStimulus            {   VSS  VDD  EN   IN    } {
                   "0"      {} {   0    0    0    0     }
       "initial_delay" { in1 } {   -    1    -    -     }
"(initial_delay)+(pp)"      {} {   -    -    -    -     }
}
...
$tempWT bindInterface { VSS VDD EN IN } { 10e-12 VDD[cycle_time] VDD[cycle_time] VDD[default_slew] cell_power_period }
