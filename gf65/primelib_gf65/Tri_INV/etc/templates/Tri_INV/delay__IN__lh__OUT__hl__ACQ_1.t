...
## 
## Test delay__IN__lh__OUT__hl
set tempTest [ SBTest "delay__IN__lh__OUT__hl" ]
$tempTest setTargets { delay__IN__lh__OUT__hl Cin__IN__lh Tout__OUT__hl cap_energy__OUT__hl energy1__IN__lh__OUT__hl__VDD energy__IN__lh__OUT__hl leakage_power1__VDD leakage_power2__VDD }
...
$tempAcq setAdditionalStateCoverage "1" "energy1__IN__lh__OUT__hl__VDD"
$tempAcq setAdditionalStateCoverage "1" "energy__IN__lh__OUT__hl"
...
$tempWT setInterface { EN IN OUT:inout } { initial_delay units ct default_slew pp energy_change_threshold energy_change_abs_threshold }
...
$tempWT addMeasurements {} {
  { tin_IN               Tin        { IN start } NO_USER SYS }
  { cin_IN               Cin        { IN start } NO_USER SYS }
  { tout_OUT             Tout       { OUT out } NO_USER SYS }
  { delay_IN_OUT         delay      { IN start OUT out } NO_USER SYS }
  { energy__IN__lh__OUT__hl energy     { start pp energy_change_threshold energy_change_abs_threshold 0 } NO_USER SYS }
  { cell_power_period    export_expr { pp } }
  { energy1__IN__lh__OUT__hl__VDD energy1    { start pp energy_change_threshold energy_change_abs_threshold 0 VDD } }
...
$tempWT bindInterface { EN IN OUT } { 10e-12 IN[cycle_time] IN[cycle_time] IN[default_slew] cell_power_period power_stabilization_threshold power_stabilization_threshold_absolute }
