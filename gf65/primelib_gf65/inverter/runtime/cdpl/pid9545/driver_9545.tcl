...
set_config_opt -- cdpl_log_subdir pid9545
...
if {[catch {
  ...
  reset_log_file
  if { [log_num_errors] > 0 } {
    if { [catch {exec mv -f $sis_log_file /home/eng/s/sxv240035/cad/gf65/primelib_gf65/inverter/runtime/cdpl/pid9545} mv_err] } {
      log_warning $mv_err
    }
  } else {
