if { [catch {
set_location /home/eng/s/sxv240035/cad/gf65/primelib_gf65/inverter
...
set_config_opt -- cdpl_log_subdir pid10236

create_parameter configure_arc_based
set_config_opt -cell inverter -- configure_arc_based 0
...
if {[catch {
  ...
  reset_log_file
  if { [log_num_errors] > 0 } {
    if { [catch {exec mv -f $sis_log_file /home/eng/s/sxv240035/cad/gf65/primelib_gf65/inverter/runtime/cdpl/pid10236} mv_err] } {
      log_warning $mv_err
    }
  } else {
