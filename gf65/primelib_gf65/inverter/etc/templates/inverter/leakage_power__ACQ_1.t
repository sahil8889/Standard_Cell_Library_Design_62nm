...
$tempAcq setState "!IN&OUT"
$tempAcq setStateCoverage "1"

## 
## Wavetable
set tempWT [ SBWaveTable ]
$tempWT setInterface { IN OUT:out } { initial_delay units ct default_slew gate_leakage_multiplication_factor trailing_delay pp }

$tempWT setStimulus                                                      {   IN   OUT   } {
                                                           "0"   { in0 } {   0    1     }
   "(0)+initial_delay+(gate_leakage_multiplication_factor*pp)" { start } {   0    1     }
"(0)+initial_delay+(gate_leakage_multiplication_factor*pp)+pp"   { end } {   0    1     }
}

$tempWT addMeasurements {} {
  { leakage_current      leakage_power { (0)+initial_delay+(gate_leakage_multiplication_factor*pp) (0)+initial_delay+(gate_leakage_multiplication_factor*pp)+pp IN {} } NO_USER SYS }
}

$tempWT bindInterface { IN OUT } { cell_initial_delay None[cycle_time] None[cycle_time] None[default_slew] gate_leakage_time_scaling_factor cell_trailing_delay cell_power_period }
