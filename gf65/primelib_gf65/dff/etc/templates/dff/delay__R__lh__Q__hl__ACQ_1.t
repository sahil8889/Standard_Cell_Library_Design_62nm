...
## 
## Test delay__R__lh__Q__hl
set tempTest [ SBTest "delay__R__lh__Q__hl" ]
$tempTest setTargets { delay__R__lh__Q__hl Cin__R__lh Tout__Q__hl cap_energy__Q__hl energy1__R__lh__Q__hl__VDD energy__R__lh__Q__hl leakage_power1__VDD leakage_power2__VDD }
...
$tempAcq setAdditionalStateCoverage "1" "energy1__R__lh__Q__hl__VDD"
$tempAcq setAdditionalStateCoverage "1" "cap_energy__Q__hl"
$tempAcq setAdditionalStateCoverage "1" "leakage_power1__VDD"
$tempAcq setAdditionalStateCoverage "1" "energy__R__lh__Q__hl"
...
$tempWT addMeasurements {} {
  { tin_R                Tin        { R start } NO_USER SYS }
  { cin_R                Cin        { R start } NO_USER SYS }
  { tout_Q               Tout       { Q out } NO_USER SYS }
  { delay_R_Q            delay      { R start Q out } NO_USER SYS }
  { energy__R__lh__Q__hl energy     { start pp energy_change_threshold energy_change_abs_threshold 0 } NO_USER SYS }
  { cell_power_period    export_expr { pp } }
  { energy1__R__lh__Q__hl__VDD energy1    { start pp energy_change_threshold energy_change_abs_threshold 0 VDD } }
...
$tempWT bindInterface { Q R D CLK } { 10e-12 R[cycle_time] R[cycle_time] R[default_slew] cell_power_period power_stabilization_threshold power_stabilization_threshold_absolute }
