if { [catch {
set_location /home/eng/s/sxv240035/cad/gf65/primelib_gf65/dff
...
set_config_opt -- cdpl_log_subdir pid30081

create_parameter configure_arc_based
set_config_opt -cell dff -- configure_arc_based 0
...
if {[catch {
  ...
  reset_log_file
  if { [log_num_errors] > 0 } {
    if { [catch {exec mv -f $sis_log_file /home/eng/s/sxv240035/cad/gf65/primelib_gf65/dff/runtime/cdpl/pid30081} mv_err] } {
      log_warning $mv_err
    }
  } else {
